...
class BlogPostsCategoryController extends Controller
{
    ...
    public function destroy($id)
    {
        try {
            ...
            if ($blogPostsCategory->image && file_exists(public_path('uploads/blogpostcategory/' . $blogPostsCategory->image))) {
                unlink(public_path('uploads/blogpostcategory/' . $blogPostsCategory->image));
            }
            ...
            return redirect()->route('admin.blog-posts-categories.index')->with('error', 'Error deleting blog post category: ' . $e->getMessage());
        }
    }
}
