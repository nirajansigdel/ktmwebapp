...
@section('content')
    ...
    <div class="row mb-2">
        <div class="col-sm-6">
            ...
            <a href="{{ route('admin.customers.index') }}"><button class="btn btn-primary btn-sm"><i class="fa fa-arrow-left"></i> Back</button></a>
        </div>
    </div>
    ...
    <form id="customerForm" method="POST" action="{{ route('admin.customers.store') }}">
        ...
        <div class="card-body">
            <div class="form-group">
                ...
                <input type="text" name="name" class="form-control" id="name" placeholder="Customer Name" value="{{ old('name') }}" required>
            </div>
            <div class="form-group">
