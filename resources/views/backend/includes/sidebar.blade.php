        ...
        <div class="navbar-vertical-content scrollbar">
            <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                ...
                <li class="nav-item">
                    <!-- Navbar vertical label -->
                    <div class="row navbar-vertical-label-wrapper mt-3 mb-2">
                        <div class="col-auto navbar-vertical-label">Parcel Tracking</div>
                        <div class="col ps-0">
                            <hr class="mb-0 navbar-vertical-divider">
                        </div>
                    </div>
                    ...
                    <!-- Dropdown item -->
                    <li class="nav-item">
                        <a class="nav-link dropdown-indicator {{ Request::segment(2) == 'parcels' ? '' : 'collapsed' }}"
                            href="#dashboard50" role="button" data-bs-toggle="collapse"
                            aria-expanded="{{ Request::segment(2) == 'parcels' ? 'true' : 'false' }}"
                            aria-controls="dashboard23">
                            <div class="d-flex align-items-center">
                                <span class="nav-link-icon"><i class="fas fa-tachometer-alt"></i></span>
                                <span class="nav-link-text ps-1">Parcels</span>
                            </div>
                        </a>
                        
                        <!-- Collapse content -->
                        <ul class="nav collapse {{ Request::segment(2) == 'parcels' ? 'show' : '' }}" id="dashboard50">
                            <!-- Customers -->
                            <li class="nav-item">
                                <a class="nav-link {{ Request::segment(2) == 'customers' ? 'active' : '' }}"
                                    href="{{ route('logistics.customers.index') }}">
                                    <div class="d-flex align-items-center">
                                        <i class="fa fa-angle-double-right"></i>
                            ...
                            <!-- Receivers -->
                            <li class="nav-item">
                                <a class="nav-link {{ Request::segment(2) == 'receivers' ? 'active' : '' }}"
                                    href="{{ route('logistics.receivers.index') }}">
                                    <div class="d-flex align-items-center">
                                        <i class="fa fa-angle-double-right"></i>
                                        <span class="nav-link-text ps-1">Receivers</span>
                                    </div>
                                </a>
                            </li>
                            ...
                            <!-- Parcels -->
                            <li class="nav-item">
                                <a class="nav-link {{ Request::segment(2) == 'parcels' ? 'active' : '' }}"
                            ...
                            <!-- Tracking Updates -->
                            <li class="nav-item">
                                <a class="nav-link {{ Request::segment(2) == 'tracking-updates' ? 'active' : '' }}"
                                    href="{{ route('logistics.tracking-updates.index') }}">
                                    <div class="d-flex align-items-center">
                                        <i class="fa fa-angle-double-right"></i>
                                        <span class="nav-link-text ps-1">Tracking Updates</span>
                                    </div>
                                </a>
                            </li>
                            ...
                            <!-- Parcel Histories -->
                            <li class="nav-item">
                                <a class="nav-link {{ Request::segment(2) == 'parcel-histories' ? 'active' : '' }}"
                                    href="{{ route('logistics.parcel-histories.index') }}">
                                    <div class="d-flex align-items-center">
                                        <i class="fa fa-angle-double-right"></i>
                                        <span class="nav-link-text ps-1">Parcel Histories</span>
                                    </div>
                                </a>
                            </li>
                        </ul>
