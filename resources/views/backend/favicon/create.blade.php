...
@section('content')
    ...
    <div class="row mb-2">
        <div class="col-sm-6">
            ...
            <a href="{{ route('admin.favicons.index') }}"><button class="btn btn-primary btn-sm"><i class="fa fa-arrow-left"></i>
                    Back</button></a>
        </div>
        <div class="col-sm-6">
            ...
            <div>
                <div class="form-group">
                    ...
                    <input type="file" name="android_chrome_oneninetwo" class="form-control"
                        ...
                        required>
                    <img id="preview_android_chrome_oneninetwo" style="display: none; max-width: 200px; max-height:200px; margin-top: 10px; border-radius: 8px; border: 2px solid #ddd;" />
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="file" name="android_chrome_fiveonetwo" class="form-control"
                        ...
                        required>
                    <img id="preview_android_chrome_fiveonetwo" style="display: none; max-width: 200px; max-height:200px; margin-top: 10px; border-radius: 8px; border: 2px solid #ddd;" />
                </div>
                ...
                <div class="form-group">
                    ...
                    <img id="preview_favicon_thirtyTwo" style="display: none; max-width: 200px; max-height:200px; margin-top: 10px; border-radius: 8px; border: 2px solid #ddd;" />
                </div>
                ...
                <div class="form-group">
                    ...
                    <img id="preview_favicon_sixteen" style="display: none; max-width: 200px; max-height:200px; margin-top: 10px; border-radius: 8px; border: 2px solid #ddd;" />
                </div>
                ...
                <div class="form-group">
                    ...
                    <img id="preview_favicon_ico" style="display: none; max-width: 200px; max-height:200px; margin-top: 10px; border-radius: 8px; border: 2px solid #ddd;" />
                </div>
                ...
                <div class="form-group">
                    ...
                    <img id="preview_apple_touch_icon" style="display: none; max-width: 200px; max-height:200px; margin-top: 10px; border-radius: 8px; border: 2px solid #ddd;" />
                </div>

                <div class="form-group">
                    <label for="site_webmanifest">Site Manifest</label><span style="color:red; font-size:large"> *</span>
                    <input type="file" name="site_webmanifest" class="form-control" id="site_webmanifest" required>
                    <small class="form-text text-muted">Upload a JSON manifest file</small>
                </div>
            </div>
        </div>
